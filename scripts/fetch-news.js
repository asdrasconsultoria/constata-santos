...
const SOURCES = [
  { id: 'santos-oficial', name: 'Santos FC Oficial', url: 'https://www.santosfc.com.br/feed/', category: 'futebol', enabled: true },
  { id: 'ge-santos', name: 'ge.globo Santos', url: 'https://globoesporte.globo.com/futebol/times/santos/rss2.xml', category: 'futebol', enabled: true },
  { id: 'gazeta-santos', name: 'Gazeta Esportiva', url: 'https://www.gazetaesportiva.com/times/santos/feed/', category: 'futebol', enabled: true },
  { id: 'diario-peixe', name: 'Diário do Peixe', url: 'https://www.diariodopeixe.com.br/feed/', category: 'futebol', enabled: true },
  { id: 'uol-esporte', name: 'UOL Esporte', url: 'https://rss.uol.com.br/feed/esporte.xml', category: 'futebol', enabled: true },
  { id: 'espn-brasil', name: 'ESPN Brasil', url: 'https://www.espn.com.br/espn/rss/news', category: 'futebol', enabled: true },
  { id: 'bolavip-santos', name: 'Bolavip Santos', url: 'https://br.bolavip.com/rss/santos-fc.xml', category: 'futebol', enabled: true },
  { id: 'torcedores-santos', name: 'Torcedores', url: 'https://www.torcedores.com/times/santos/feed', category: 'futebol', enabled: true },
  { id: '90min-santos', name: '90min', url: 'https://www.90min.com/pt-BR/teams/santos-fc/feed', category: 'futebol', enabled: true },
  { id: 'atribuna', name: 'A Tribuna', url: 'https://www.atribuna.com.br/rss/esportes.xml', category: 'futebol', enabled: true },
];
